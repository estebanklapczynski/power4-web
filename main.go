...
func handleIndex(w http.ResponseWriter, rhttp.Request) {
...
func handlePlay(w http.ResponseWriter, rhttp.Request) {
...
func handleRestart(w http.ResponseWriter, rhttp.Request) {
    currentGame = game.NewGame()
    http.Redirect(w, r, "/", http.StatusSeeOther)
}
